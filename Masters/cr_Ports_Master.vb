...
Public Class cr_Ports_Master
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MSI_Solution.cr_Ports_Master.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_Ports_Master
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_Ports_Master = New cr_Ports_Master()
        rpt.Site = Me.Site
        Return rpt
    End Function
